...
var json = require("../../runtime/json-observe");
var expect = require("expect.js");

describe("Json Observe", function() {

  var obj, obj2, chg1 = {}, chg2, chg3, chgsz1 = 0,
    chgcount = 0;
  ...
  it("tests array sort 1", function() {
    var arr = ["D", "C", "A", "E", "B"];
  ...
  it("tests array sort 2", function() {
    var arr = ["D3", "C1", "A4", "E2", "B5"];
